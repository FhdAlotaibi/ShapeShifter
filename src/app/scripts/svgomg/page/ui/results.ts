...
export default class Results {
  container: any;
  private _selectedEl: any;
  private _sizeSelectedEl: any;
  private _diffSelectedEl: any;
  private _totalEl: any;
  private _labelTotalEl: any;
  private _sizeTotalEl: any;
  private _diffTotalEl: any;
  ...
  update({ sizeTotal, compareToSizeTotal, sizeSelected, compareToSizeSelected }) {
    this._updateEl({
      size: sizeSelected,
      compareToSize: compareToSizeSelected,
      sizeEl: this._sizeSelectedEl,
      diffEl: this._diffSelectedEl,
    });
    this._updateEl({
      size: sizeTotal,
      compareToSize: compareToSizeTotal,
      sizeEl: this._sizeTotalEl,
      diffEl: this._diffTotalEl,
    });
    const selectedDisplay =
      sizeSelected === sizeTotal && compareToSizeSelected === compareToSizeTotal ? 'none' : '';
