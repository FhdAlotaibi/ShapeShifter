import { domReady, escapeHtmlTag, strToEl, transitionToClass } from '../utils';

export default class Changelog {
  container: any;
  private _loadedVersion: any;
  ...
  async showLogFrom(lastLoadedVersion) {
    ...
    this.container.appendChild(strToEl('<ul>' + changeLis.join('') + '</ul>' + ''));
