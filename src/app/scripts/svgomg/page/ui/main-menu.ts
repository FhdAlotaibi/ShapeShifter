...
export default class MainMenu extends EventEmitter {
  ...
  private _fileItemTemplate: any;
  private _fileItemEls: any;
  private _fileItemElsContainerEl: any;
  private _fileItemElsInsertBeforeEl: any;
  private _loadFileInput: any;
  private _pasteInput: any;
  private _loadDemoBtn: any;
  private _loadFileBtn: any;
  private _pasteLabel: any;
